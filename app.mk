...
libcurl_PATH := $(strongswan_PATH)/../curl
...
include $(addprefix $(LOCAL_PATH)/,$(addsuffix /Android.mk, $(strongswan_BUILD)) )
#openssl is in curl build
include $(libcurl_PATH)/app.mk
