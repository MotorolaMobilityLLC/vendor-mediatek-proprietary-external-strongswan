    ...
    bool wifi_ho_ip_change)
{
    ...
    this->wifi_ho_ip_change = wifi_ho_ip_change;
}
...
METHOD(peer_cfg_t, wifi_ho_ip_change_, bool,
	private_peer_cfg_t *this)
{
	return this->wifi_ho_ip_change;
}
							...
							identification_t *peer_id)
{
	...
	INIT(this,
		.public = {
            ...
            .wifi_ho_ip_change = _wifi_ho_ip_change_,
