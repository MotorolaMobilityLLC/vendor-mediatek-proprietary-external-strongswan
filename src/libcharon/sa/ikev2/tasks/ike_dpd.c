	...
	private_ike_dpd_t *this, message_t *message)
{
    ...
    if (address && peer_cfg && !peer_cfg->wifi_ho_ip_change(peer_cfg))
    {
        DBG1(DBG_IKE, "start delete because ip changed during wifi2wifi ho");
        this->ike_sa->delete(this->ike_sa, 0);
